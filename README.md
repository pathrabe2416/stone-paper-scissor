...
Choose between Player vs AI or Player vs Player (pass-and-play) modes 
and outsmart an AI that actually learns your patterns!
...
single file, zero installation needed


Select your mode:

vs AI for a solo challenge or vs Player to battle a friend


Click one of the glowing weapon cards —
...
The AI isn't random.
It runs a frequency-based prediction engine:
